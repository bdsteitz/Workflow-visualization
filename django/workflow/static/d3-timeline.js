      ...
      g.each(function(d, i) {
        d.forEach( function(datum, index){
          ...
          if (rowSeperatorsColor) {
            var lineYAxis = ( -10+itemHeight + itemMargin / 2 + margin.top + (itemHeight + itemMargin) * yAxisMapping[index]);
          ...
          gParent.append("svg:line")
            .attr("x1", 0)
            .attr("x2", 0)
            .attr("y1", lineYAxis-23)
            .attr("y2", lineYAxis-2)
            .attr("stroke-width", 10)
            .attr("stroke", colorCycle(index));
          ;
          ...
          if (hasLabel) {
            gParent.append("text")
              ...
              .attr("transform", "translate("+ 7 +","+ (-11 + itemHeight * 0.75 + margin.top + (itemHeight + itemMargin) * yAxisMapping[index])+")")
